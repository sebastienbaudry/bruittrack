#!/usr/bin/env bash
# BruitTrack â€” installation reproductible sur hpdebian (Debian 13, HP T620).
...
# --- c.1 : prÃ©-requis systÃ¨me (root requis pour apt/useradd/policykit) ----
...
echo "INSTALL_OK â€” 'journalctl -u bruittrack -e' pour l'inspection.
